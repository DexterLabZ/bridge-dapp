...
const TokenSelectModal: FC<{
  ...
  onDismiss,
    ...
    return (
      <div
        className={`token-select-modal-container ${isFirstRender ? "hidden-modal" : ""} ${isModalOpen ? "open-modal" : "closed-modal"
          }`}>
                  ...
                  {availableNetworks.map((network, index) => {
                    return (
                      <div
                        ...
                        className={`selectable-chip mr-2 ${selectedNetwork?.chainId === network.chainId ? "selected" : ""
                          }`}>
                        <div className="mr-1">
