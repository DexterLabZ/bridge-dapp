...
export const alternativeWznnAbi = ["function balanceOf(address)", "function decimals()"];
...
export const abiContract = `[
  ...
  "function unwrapNative(string) payable",
  "function redeem(address,address,uint256,uint256,bytes)",
  "function redeemNative(address,uint256,uint256,bytes)",
